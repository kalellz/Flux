...
<section class="localizacao">
        ...
        <div class="localizacaocontainer">
            ...
            <button class="botaolocalizacao" onclick="location.href = '../feed/';"> ME LEVE AO FEED</button>
        </div>
    </section>
    ...
    <section class="ultimo">
        <div class="parteroxa">
            <div>
                <h1 class="ultimos-titulos">
                    LOCALIZAÇÃO
                </h1>
                <p class="ultimos-textos">
                    Rua Adele nº 95 apto: 234
                </p>
                <h1 class="ultimos-titulos">
                    TELEFONES
                </h1>
        ...
        <div id="formulario">
            ...
            <div class="ultimocontainer">
                ...
                <input class="tipotexto" type="text" name="" id=""></input>
                <p class="ultimostext">
                    E-mail
                </p>
                <input class="tipotexto" type="text" name="" id=""></input>
                ...
                <textarea class="messageinput" id="">
                </textarea>
                
            </div>
            <button class="ultimobotao">
                ENVIAR
            </button>
        </div>
    </section>
