    ...
    <main>
      <header className="header-anun">
        <div className="cima">
          ...
          <div className="busca">
            <input type="text" className="pesquisa">
              Pesquise por qualquer coisa que quiser!
            </input>
        ...
        <div className="baixo">
          <div className="content">
            ...
            <div>
              <a href="../anuncios/anuncios.html" className="botao1">
                Anúncios
              </a>
            </div>
            <div>
              <a href="../feed/index.html" className="botao1">
                Feed
              </a>
            </div>
          </div>
      ...
      <section className="formulario">
        ...
        <div className="inputs">
          ...
          <input type="text" className="form-input">
            Coloque um preço no seu produto.
          </input>
        </div>
        <div className="field">
          <select name="" id="" className="categorias">
        ...
        <div className="inputs">
          ...
          <input type="text" className="form-input">
            Digite o seu perfil do instagram.
          </input>
        </div>
        <div className="inputs">
          <p className="anun-p">Whatsapp</p>
          <input type="text" className="form-input">
            este número irá se transformar em um botão para seu número.
          </input>
        </div>
        <div className="inputs">
          <p className="anun-p">Facebook</p>
          <input type="text" className="form-input">
            Digite o seu perfil do Facebook.
          </input>
        </div>
        <div className="inputs">
          <p className="anun-p">Twitter</p>
          <input type="text" className="form-input">
            Digite o seu perfil do Twitter.
          </input>
        </div>
