					...
					<section className="login-container">
						<div className="roxa">
							<div className="roxa-content">
								...
								<p className="p-roxa">Para se conectar, por favor coloque suas informações de login!</p>
						...
						<div className="branca">
							<div className="branca-content">
								...
								<div className="container-input">
									<div className="email">
										<img src={user} width="24px" className="input-img" alt="user"></img>
										<input type="text" className="input-login" placeholder="Nome" value={nome} onChange={(e) => setNome(e.target.value)}></input>
									</div>
									<div className="email">
										<img src={mail} width="24px" className="input-img" alt="mail"></img>
										<input type="email" className="input-login" placeholder="E-mail" value={email} onChange={(e) => setEmail(e.target.value)}></input>
									</div>
									<div className="email">
										<img src={lock} width="24px" className="input-img" alt="lock"></img>
										<input type="password" className="input-login" placeholder="Senha" value={senha} onChange={(e) => setSenha(e.target.value)}></input>
									</div>
									<button className="branca-btn" onClick={entrarClick} disabled={carregando}>
										cadastrar
									</button>
									<div className="errologin">{erro}</div>
								</div>
							</div>
						</div>
					</section>
